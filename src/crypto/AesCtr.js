...
class AES{
     ...
     */
    constructor(key){
        if(key.length < 16) key = pkcs7pad(key, 16);
        else if(key.length % 8 !== 0)  key = pkcs7pad(key, 8);
...
class Counter{
    constructor(initialValue) {
        ...
        if (initialValue !== 0 && !initialValue) { initialValue = 5; }
